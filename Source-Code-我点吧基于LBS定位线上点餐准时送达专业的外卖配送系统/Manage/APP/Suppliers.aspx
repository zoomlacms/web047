<%@ page language="C#" autoeventwireup="true" inherits="manage_APP_Suppliers, App_Web_zyp5wqep" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <table class="table table-striped table-bordered">
                ...
                <tr>
                    ...
                    <td>
                        <div class="input-group margin_b2px">
                            <span class="input-group-addon">Key</span>
                            <asp:TextBox runat="server" ID="BQY_Key_T" CssClass="form-control text_300" />
                            <span class="input-group-addon">Secret</span>
                            <asp:TextBox runat="server" ID="BQY_Secret_T" CssClass="form-control text_300" />
                        </div>
                        <div class="input-group">
                            <span class="input-group-addon">回调</span>
                            <asp:TextBox runat="server" ID="BQY_CallBack_T" CssClass="form-control" />
                        </div>
                    </td>
                </tr>
                <tr>
