namespace Zoomla.Website.manage.Shop
{
    ...
    public partial class OrderList : CustomerPageAction
    {
        ...
        //根据推荐人查下级用户
        public int PUid { get { return DataConvert.CLng(Request.QueryString["puid"]); } }
        //订单类型
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                Call.SetBreadCrumb(Master, "<li><a href='ProductManage.aspx'>" + Resources.L.商城管理 + "</a></li><li><a href='OrderList.aspx'>" + Resources.L.订单管理 + "</a></li><li class='active'><a href='OrderList.aspx'>" + Resources.L.订单列表 + "</a></li>" + Call.GetHelp(41));
                MyBind();
            }
        }
        protected void MyBind()
        {
            ...
            if (PUid > 0) 
            {
                ...
                foreach (DataRow dr in udt.Rows) { uids += dr["UserID"] + ","; }
                uids = uids.Trim(',');
            }
