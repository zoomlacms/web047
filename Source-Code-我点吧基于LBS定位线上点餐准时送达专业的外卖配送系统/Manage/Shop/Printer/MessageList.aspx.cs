...
public partial class Manage_Shop_Printer_MessageList : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            MyBind();
            Call.SetBreadCrumb(Master, "<li><a href='" + CustomerPageAction.customPath2 + "Main.aspx'>工作台</a></li><li><a href='" + CustomerPageAction.customPath2 + "/Shop/Printer/ListDevice.aspx'>智能硬件</a></li><li class='active'>流水详情</li>");
        }
    }
    private void MyBind()
    {
