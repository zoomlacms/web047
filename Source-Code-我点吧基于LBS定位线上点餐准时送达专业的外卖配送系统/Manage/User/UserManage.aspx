...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <div>
        <table id="EGV" class="table table-striped table-bordered table-hover">
            ...
            <ZL:Repeater runat="server" ID="RPT" PageSize="20"  PagePre="<tr><td><label class='allchk_l'><input type='checkbox' id='AllID_Chk'>全选</label></td><td colspan='13'><div class='text-center'>" PageEnd="</div></td></tr>">
                <ItemTemplate>
