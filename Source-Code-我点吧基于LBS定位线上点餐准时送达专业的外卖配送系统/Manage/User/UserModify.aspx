<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.User.UserPassModify, App_Web_pm0re3oi" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <div class="tab-pane active" id="Tabs0">
            <table class="table table-striped table-bordered table-hover">
                ...
                <tr class="tdbg">
                    ...
                    <td class="text-left">
                        <asp:TextBox ID="txtMoney" runat="server" Enabled="false" class="form-control" Style="max-width: 200px;"></asp:TextBox>
                    </td>
                    <td class="text-right">用户信誉值</td>
                    <td>
                        <asp:TextBox ID="txtUserCrite" runat="server" Enabled="false" class="form-control" Style="max-width: 200px;"></asp:TextBox></td>
                </tr>
                <tr>
                    <td class="text-right">用户银币：</td>
                    <td class="text-left">
                        <asp:TextBox ID="txtSilverCoin" runat="server" Enabled="false" class="form-control" Style="max-width: 200px;"></asp:TextBox>
                    </td>
                    <td class="text-right">用户积分： </td>
                    <td class="text-left">
                        <asp:TextBox ID="txtPoint" runat="server" Enabled="false" class="form-control" Style="max-width: 200px;"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td class="text-right">点券： </td>
                    <td class="text-left">
                        <asp:TextBox ID="txtUserPoint" Enabled="false" runat="server" class="form-control" Style="max-width: 200px;"></asp:TextBox>
                    </td>
                    <td class="text-right">虚拟币： </td>
                    <td class="text-left">
                        <asp:TextBox ID="txtPurm" runat="server" Enabled="false" class="form-control" Style="max-width: 200px;"></asp:TextBox>
                    </td>
                </tr>
            ...
            <table class="table table-striped table-bordered table-hover">
                ...
                <tr>
                    ...
                    <td class="text-left">
                        ...
                        <asp:RegularExpressionValidator runat="server" ID="Mobile_R" ErrorMessage="手机号码格式不正确" ValidationExpression="^1\d{10}$" SetFocusOnError="true" Display="Dynamic" ForeColor="Red" ControlToValidate="tbMobile" />
                    </td>
