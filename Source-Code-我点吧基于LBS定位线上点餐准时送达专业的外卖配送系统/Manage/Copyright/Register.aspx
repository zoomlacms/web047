<%@ page language="C#" autoeventwireup="true" inherits="Manage_Copyright_BqyReister, App_Web_kf50gi52" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <div class="alert alert-info in margin_b2px">
            ...
            <p style="padding-left: 50px; line-height: 40px;">
                <strong><i class="fa fa-bullhorn" style='font-size: 18px;'></i>
                    让每一个字节的版权都受到保护，版权保护由Zoomla!逐浪CMS官方与北京版权印股份有限公司联合提供，版权印公司负责相应细节和分成。<br />
