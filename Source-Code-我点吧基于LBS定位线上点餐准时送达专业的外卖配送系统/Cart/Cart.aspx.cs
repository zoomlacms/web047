...
public partial class test_Cart : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (model.ProID > 0)//将商品加入购物车
            {
                ...
                Response.Redirect(Request.Url.AbsolutePath + "?ProClass=" + proMod.ProClass + "&remark=" + Request["remark"]);
            }
            MyBind();
        }
    }
   ...
   //小计
    ...
    protected void NextStep_Click(object sender, EventArgs e)
    {
        ...
        string ids = Request.Form["prochk"];
        Response.Redirect("GetOrderInfo.aspx?ids=" + ids + "&ProClass=" + ProClass+"&remark="+Request["remark"]);//"#none"
    }
    //-----后期整合
