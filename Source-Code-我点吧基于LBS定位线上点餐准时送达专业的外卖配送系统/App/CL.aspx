<%@ page language="C#" autoeventwireup="true" inherits="App_CreateLink, App_Web_of0eqajc" masterpagefile="~/Common/Master/Commenu.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
      ...
      <div class="col-md-7 col-lg-7">
           <table class="table table-bordered table-striped">
            ...
            <tr>
                ...
                <a href="CLList.aspx" class="btn btn-lg btn-primary">返回颁发列表</a>
                </td>
            </tr>
        </table>
      </div>
