    ...
    public partial class Orderpay : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                pointli.Visible = false; //SiteConfig.SiteOption.SiteID.Contains("point");
                ...
                else
                {
                    ...
                    JObject obj = (JObject)JsonConvert.DeserializeObject(orderMod.AllMoney_Json);
                    if (orderMod.Ordersamount == 0 && DataConverter.CLng(obj["Point"].ToString()) > 0)
                    {
                ...
                if (orderDT != null && orderDT.Rows.Count > 0)
                {
                    ...
                    else { OrderNo_L.Text = payMod.PaymentNum; }
                }
                //支付平台
                BindPlat();
            }
        ...
        protected void BtnSubmit_Click(object sender, EventArgs e)
        {
            ...
            string url = "PayOnline.aspx?PayNo=" + pinfo.PayNo+"&appid="+Request["appid"];
        ...
        protected void PoinPay_Btn_Click(object sender, EventArgs e)
        {
            int platid = 0;
            M_UserInfo mu = buser.GetLogin(false);
            M_Payment pinfo = new M_Payment();
