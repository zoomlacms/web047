...
public partial class User_Default2 : CustomerPageAction
{
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        if (mu1 == null || mu1.IsNull || mu1.UserID < 1) { Response.Redirect("/wxpromo.aspx?appid=2&r=/User/Default2.aspx"); }
        else if (mu1.Status != 0) { function.WriteErrMsg("你的帐户未通过验证或被锁定，请与网站管理员联系", "/wxpromo.aspx?appid=2&r=/User/Default2.aspx"); }
        ...
        else if (badmin.CheckLogin())
        {
            ...
            else if (mu.Status != 0) { function.WriteErrMsg("你的帐户未通过验证或被锁定，请与网站管理员联系", "/wxpromo.aspx?appid=2&r=/User/Default2.aspx"); }
    ...
    {
        appMod = appBll.SelReturnModel(2);
        string url = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=" + appMod.APPID + "&redirect_uri=http%3a%2f%2fv.wodian8.com%2fwxshare.aspx%3fappid%3d2&response_type=code&scope=snsapi_userinfo&state=STATE#wechat_redirect";
