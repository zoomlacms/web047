...
<div class="container">
    <table class="table table-bordered table-hover table-striped">
            <tr><td class="td_m">现有银币：</td><td><asp:Label runat="server" ID="NowMoney_L" /></td></tr>
      <%--      <tr><td>申请日期：</td><td><asp:Label runat="server" ID="CDate_L" /></td></tr>--%>
            ...
            <tr><td></td><td><asp:Button runat="server" CssClass="btn btn-primary" ID="Sure_Btn" Text="申请提现" OnClick="Sure_Btn_Click"/></td></tr>
        </table>
</div>
</asp:Content>
