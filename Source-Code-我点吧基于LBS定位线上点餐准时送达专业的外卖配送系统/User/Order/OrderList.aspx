...
.prolist .media { padding:10px 15px; border-bottom: 1px dotted #e3e5e9;}
.prolist .media-left img { width:60px; height:60px; border:1px solid #e0e0e0; border-radius:4px;}
...
<p>
<span style="color:#c00;">x<%#Eval("Pronum") %></span>
