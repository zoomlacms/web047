<%@ page language="C#" autoeventwireup="true" inherits="User_UserShop_AddProduct, App_Web_x5ociwkv" masterpagefile="~/User/Default.master" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<table class="table table-striped table-bordered">
    <tbody id="Tabs0" style="border-top: none;">
        ...
        <tr>
            ...
            <td>
                <input type="radio" id="normal" checked="checked" value="1" name="ProClass" /><label for="normal">堂食</label>
                <input type="radio" id="TeJia" value="2" name="ProClass" /><label for="TeJia">外卖</label>
