<%@ page language="C#" autoeventwireup="true" inherits="User_UserShop_Orderlistinfo, App_Web_x5ociwkv" masterpagefile="~/User/Default1.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<asp:Content runat="server" ContentPlaceHolderID="head">
<title>订单信息</title>
<style>
.order_prolist .weui_cells { font-size:1em;}
.order_prolist .weui_cells p { margin-bottom:0;}
.weui_media_box .weui_media_desc { margin-bottom:0; color:#c00;}
.weui_panel h4 { margin-top:0;}
</style>
</asp:Content>
...
<a href="/Shop/<%#Eval("ProID")%>.aspx"><img class="weui_media_appmsg_thumb" src="<%#ZoomLa.Common.function.GetImgUrl(Eval("Thumbnails"))%>" onerror="this.src='/Images/nopic.gif';" alt="<%# Eval("Proname")%>" /></a>
</div>
<div class="weui_media_bd">
<h4 class="weui_media_title"><%#Eval("proname")%></h4>
<p class="weui_media_desc">x<%#Eval("pronum") %>=<%#GetLinPrice()%></p>
</div>
</div>
</div>
...
<div class="weui_cell">
<div class="weui_cell_bd weui_cell_primary"><p>用户名</p></div>
<div class="weui_cell_ft"><span id="Rename" runat="server"></span></div>
</div>

<div class="weui_cell">
<div class="weui_cell_bd weui_cell_primary"><p>客户名称</p></div>
<div class="weui_cell_ft"><asp:Label ID="Reuser" runat="server"></asp:Label></div>
</div>

<div class="weui_cell">
<div class="weui_cell_bd weui_cell_primary"><p>购买日期</p></div>
<div class="weui_cell_ft"><asp:Label ID="adddate" runat="server"></asp:Label></div>
</div>

<div class="weui_cell">
<div class="weui_cell_bd weui_cell_primary"><p>下单日期</p></div>
<div class="weui_cell_ft"><asp:Label ID="addtime" runat="server"></asp:Label></div>
</div>

<div class="weui_cell">
<div class="weui_cell_bd weui_cell_primary"><p>付款状态</p></div>
<div class="weui_cell_ft"><asp:Label ID="Paymentstatus" runat="server"></asp:Label></div>
</div>

<div class="weui_cell">
<div class="weui_cell_bd weui_cell_primary"><p>物流状态</p></div>
<div class="weui_cell_ft"><asp:Label ID="StateLogistics" runat="server"></asp:Label></div>
</div>
...
<div class="weui_cells">
<div class="weui_cell">
<div class="weui_cell_bd weui_cell_primary"><p>收件人姓名</p></div>
<div class="weui_cell_ft"><asp:Label ID="Reusers" runat="server"></asp:Label></div>
</div>

<div class="weui_cell">
<div class="weui_cell_bd weui_cell_primary"><p>手机</p></div>
<div class="weui_cell_ft"><asp:Label ID="Mobile" runat="server"></asp:Label></div>
</div>

<div class="weui_cell">
<div class="weui_cell_bd weui_cell_primary"><p>收货人地址</p></div>
<div class="weui_cell_ft"><asp:Label ID="Jiedao" runat="server"></asp:Label></div>
</div>

<div class="weui_cell">
<div class="weui_cell_bd weui_cell_primary"><p>付款方式</p></div>
...
<tr>
<td style="width: 13%;">客户名称：</td>
<td style="width: 14%;">用 户 名：</td>
<td style="width: 13%;">购买日期：</td>
<td style="width: 20%;">下单日期：</td>
</tr>
<tr>
<td style="width: 13%;">需开发票：<asp:Label ID="Invoiceneeds" runat="server"></asp:Label></td>
<td style="width: 14%;">已开发票：<asp:Label ID="Developedvotes" runat="server"></asp:Label></td>
<td style="width: 13%;">付款状态：</td>
<td style="width: 20%;">物流状态：</td>
</tr>
</tbody>
</table>
</div>
...
<tr>
<td>付款方式：</td>
<td><asp:Label ID="Payment" runat="server"></asp:Label></td>
</tr>
<tr>
<td>发票信息：</td>
<td><asp:Label ID="Invoice" runat="server"></asp:Label></td>
</tr>
<tr>
<td>缺货处理：</td>
<td><asp:Label ID="Outstock" runat="server"></asp:Label></td>
</tr>
<tr>
<td>订单类型：</td>
<td><asp:Label ID="Ordertype" runat="server"></asp:Label>
</td>
</tr>
...
{%>
<tr>
<td style="height: 24px">淘宝交易号：
</td>
<td style="height: 24px"><asp:Label ID="lbAlipayNO" runat="server"></asp:Label>
</td>
</tr>
<%} %>
</table>
...
<tr>
<td>送货方式：</td>
<td><asp:Label ID="Delivery" runat="server"></asp:Label>
</td>
</tr>
<tr>
<td>跟单员：</td>
...
<tr>
<td>要求送货时间：</td>
<td><asp:Label ID="Deliverytime" runat="server"></asp:Label>
</td>
</tr>
</table>
</div>
...
<table class="table table-striped table-bordered table-hover">
<tr>
<td style="width:200px;">内部记录（<a href="javascript:;" onclick="ShowMore('more_div');" title="编辑内部记录" style="color: #1963aa;">编辑</a>）：</td>
<td>
<asp:Label ID="Internalrecords" runat="server"></asp:Label>
</td>
</tr>
<tr>
<td>备注留言（<a href="javascript:;" onclick="ShowMore('more_div2');" title="编辑备注留言" style="color: #1963aa;">编辑</a>）：</td>
<td>
...
<td colspan="3">合计： <asp:TextBox ID="Label2" runat="server" CssClass=" form-control" Width="116px"></asp:TextBox>
